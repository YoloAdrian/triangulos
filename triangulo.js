function Area() {
    var lado1 = parseFloat(document.getElementById('l1').value);
    var lado2 = parseFloat(document.getElementById('l2').value);
    var lado3 = parseFloat(document.getElementById('l3').value);
